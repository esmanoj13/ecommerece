...
//2. Uncaught error- mainly occurs when you try to use or access an undefined variable.
//This error can be raised when you're using vanilla JavaScript or any Javascript framework.